            ...
            <a class="nav-link " id="settings-tab"  href="/User_Wallet_Address" ><i class="icon ion-md-settings"></i>Wallet Address</a>
                ...
                <div class="col-md-8">
                    ...
                    <div class="assets_page withdrawal py2">
                        <div class="row">
                            <div class="col-md-8">
                                <h2 class="trade_heading">KYC Details</h2>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="amount_rate">
                                            <div class="input-group">
                                                ...
                                                // onChange={User_Name} 
                                                class="form-control text_inputcss" readOnly name="name" placeholder="Enter ID Proof No" />
                                            </div>
                                        </div>
                                    </div>
                                    {/* <div class="form-group">
                                ...
                                <div class="wdrlBtn">
                                        <button type="button"  class="btn">Submit KYC</button>
                                    </div>
                            </div>
                            {/* <div class="wdrlBtn">
